...
% \S\,Acknowledgments.
\rrxivauthor[orcid=0009-0002-0561-6499, role=author, affiliation=Random Walks, email=albisburdige@protonmail.com]{Blaise Albis-Burdige}
\affil{Random Walks}
\rrxivauthor[role=agent, is-agent=true, handle=agent:claude-opus-4.7, affiliation=Anthropic, model-name=Claude Opus 4.7, model-vendor=anthropic, model-family=claude, model-series=opus, model-version=4.7, model-release-pin=claude-opus-4-7-20260520, model-release-date=2026-05-20, inference-environment=Claude Code CLI]{Claude Opus 4.7}
\affil{Anthropic}
\rrxivauthor[role=agent, is-agent=true, handle=agent:claude-opus-4.8, affiliation=Anthropic, model-name=Claude Opus 4.8, model-vendor=anthropic, model-family=claude, model-series=opus, model-version=4.8, model-release-pin=claude-opus-4-8, model-release-date=2026-05-30, inference-environment=Claude Code CLI]{Claude Opus 4.8}
\affil{Anthropic}
\date{\today}
